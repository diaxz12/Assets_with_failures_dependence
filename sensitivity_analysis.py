...
short_term = Failure_mode_degradation(initial_condition = 10, failure_threshold = 100, average_degradation_parameter = 2, variability_degradation_parameter = 4,
                                      degradation = [], inspection = 15, time_maintenance_threshold = 100, condition_maintenance_threshold = 100, inspection_costs = 10, sensor_costs = 100, preventive_maintenance_costs= 100, corrective_maintenance_costs = 200) #short-term failure mode definition
long_term = Failure_mode_degradation(initial_condition = 0, failure_threshold = 200, average_degradation_parameter = 0.1, variability_degradation_parameter = 2,
                                     degradation = [], inspection = 15, time_maintenance_threshold = 200, condition_maintenance_threshold = 200, inspection_costs = 10, sensor_costs = 100, preventive_maintenance_costs= 200, corrective_maintenance_costs = 1000) #long-term failure mode definition
...
maintenance_policy_list = ['TBM','CBM','ICBM']
