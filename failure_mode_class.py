...
class Failure_mode_degradation:
    ...
    def __init__(self, initial_condition, failure_threshold, average_degradation_parameter, variability_degradation_parameter, degradation, condition_maintenance_threshold, preventive_maintenance_costs, corrective_maintenance_costs):
